...
Both remaining items are deliberately **not** actionable right now (one upstream-blocked, one scoped out on purpose) — everything else queued as of the previous pass has shipped. New candidates get added here as they're identified.
