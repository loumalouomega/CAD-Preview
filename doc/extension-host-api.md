...
- Sidebar (`#side`) containing the tree panel (`#tree-panel`), the Parts panel (`#parts-panel`), the Edits panel (`#edits-panel`), the FE Mesh panel (`#meshing-panel`), the Mass Properties panel (`#mass-panel`), and the Clash panel (`#clash-panel`, B-rep sources only — hidden otherwise).
