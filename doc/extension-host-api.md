...
`exportGeoUnrolled` (i.e. the first time the user clicks **▶ Generate** or an
**Export .msh**/**Export .geo** button — never on file open). Reads
...
**Export .geo** button offer a `.geo_unrolled` target without a second
