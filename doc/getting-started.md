...
| Where | Controls |
|---|---|
| **In the row** | Icon **navigation** — reset view, fit, zoom out, zoom in — then the **Display** modes (Shaded / Wire / X-Ray / Hidden / Flat), the **Clip** plane (its on/off toggle, then X / Y / Z and the offset slider), **Persp / Ortho**, and the **Units** dropdown |
