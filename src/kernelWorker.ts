...
import { getEntityFacts, measureEntities, measureExact, checkInterference, checkInterferenceAll, rebindPartsAcrossOps, resolveBucketSelector, synthesizeSelector } from "./entityFacts";
